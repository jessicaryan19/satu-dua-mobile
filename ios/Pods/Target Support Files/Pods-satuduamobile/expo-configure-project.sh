...
with_node \
  ...
  --target "/Users/jessicaryan/Documents/Projects/Satudua/satu-dua-mobile/ios/Pods/Target Support Files/Pods-satuduamobile/ExpoModulesProvider.swift" \
  --entitlement "/Users/jessicaryan/Documents/Projects/Satudua/satu-dua-mobile/ios/satuduamobile/satuduamobile.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-audio" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-location" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
